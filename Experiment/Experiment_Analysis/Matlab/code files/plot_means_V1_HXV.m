function plot_means_V1_HXV(H0_data_V1,H0_data_V2,H0_data_V3,HA_data_V1,HA_data_V2,HA_data_V3,c_t_code,hyp_vers,order,status)
%adjust data
...
fig_name=strcat('Hypothesis_',hyp_vers,'_',order);
...
% legend_handle = legend([V1H0,V1Ha,V2H0,V2Ha,V3H0,V3Ha],{'V1-H_0','V1-H_1','V2-H_0','V2-H_1','V3-H_0','V3-H_1'});
% %legend('V1-H_0','V1-H_1','V2-H_0','V2-H_1','V3-H_0','V3-H_1','Location','bestoutside'); %,'Orientation','horizontal'
%
% newPosition = [1 1 1 1];
%
% newUnits = 'normalized';
%
% set(legend_handle,'Position', newPosition,'Units', newUnits);
%
