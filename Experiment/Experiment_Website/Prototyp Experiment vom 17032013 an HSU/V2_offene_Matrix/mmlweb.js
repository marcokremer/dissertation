...
if (tmCurTime>tmTotalSec*1000) {clearInterval(tmInt); tmTimeUp=true; alert('Zeit ist zu Ende! Zur nächsten Seite.'); erwartungswert('submit','submit','submit');document.location.href= nextURL;  return;}
if (tmTimeUp){alert('Zeit ist zu Ende! Nächste'); }
if (tmFill) {
...
var eingabe;
	do{
	erwartung = prompt("Welche Auszahlung erwartest Du?","");
