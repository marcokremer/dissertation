...
<p>Du bist der Zeilenspieler. Deine Aufgabe ist es nun, diejenigen Strategie zu wählen, mit der du die höchste Auszahlung für dich generierst!
...
</TR><tr><td colspan=2><!-- Begin HTML Time Bar --><table><tr><td>Timer: </td><td colspan=2><div id="tmCont" class="tmCont"><div id="tmBar" class="tmBar"></div><div id="tmTime" class="tmTime"></div></div></td><td></td></TR></table><!-- End HTML Time Bar --></td><TD ID="submit" style="border-left-style: none; border-right-style: none; border-bottom-style: none;" align=center valign=middle><INPUT type="submit" value="nächste Seite" onClick=erwartungswert('submit','submit','submit')></TD></tr></TABLE>
<!-- END MOUSELAB TABLE -->
<!--BEGIN postHTML-->
