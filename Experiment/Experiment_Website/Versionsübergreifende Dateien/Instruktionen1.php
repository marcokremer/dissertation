...
<form>
<TABLE ><TR><TD valign="top"><img src="ein_feld_offen.png" alt="ein_feld_offen"><br><span style="font: italic; font-size:70%;">Bild 1 Felder öffnen und schließen</span></TD>
...
<TD><p>Die Matrix: Alle Spiele werden in Matrixform präsentiert, wie zum Beispiel im Bild 2. Du siehst hier eine 2x2-Ergebnis-Matrix mit jeweils zwei Zeilen und zwei Spalten. Die Zahlen in den Feldern symbolisieren Punkte: 
die erste Zahl deine und die zweite Zahl die deines Gegenspielers. Eine Zeile entspricht einer Entscheidungsmöglichkeit (=Strategie) für dich. Deinen Gegenspieler wählt eine Spalte aus. Gegebenenfalls sind die Zahlen in den Feldern anfangs noch verdeckt. Durch Klick mit der Maus auf das Feld kannst du sie 
anzeigen lassen oder wieder verschließen, falls du sie nicht mehr benötigst. Unter der Ergebnis-Matrix zeigt dir der Timer an, wieviel Zeit dir noch für deine Entscheidung bleibt. In diesem Fall sind es noch 18 Sekunden.</p>
