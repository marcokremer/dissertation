...
% heuristic_list={ 'Altruist' 'Optimist' 'Pessimist' 'Naiive' 'L2' 'D1' 'D2' 'Equilibrium'};
...
for i=7:9%Syntax
    ...
    heuristic_dat= strcat('EIP_SIM_', heuristic_name, '_col.m');
%     load(['EIP_SIM_' heuristic_name{1,1} '_col']);
    ...
    var_name=strcat('EIP_SIM_', heuristic_name, '_col.mat');
