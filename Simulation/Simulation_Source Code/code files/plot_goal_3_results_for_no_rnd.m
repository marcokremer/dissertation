...
load('D1_no_rnd_Erg.mat')
D1_Erg=heuristic_Erg;
load('D2_no_rnd_Erg.mat')
D2_Erg=heuristic_Erg;
load('Altruist_no_rnd_Erg.mat')
Altruist_Erg=heuristic_Erg;
load('Equilibrium_no_rnd_Erg.mat')
Equilibrium_Erg=heuristic_Erg;
load('L2_no_rnd_Erg.mat')
L2_Erg=heuristic_Erg;
load('Naiive_no_rnd_Erg.mat')
Naiive_Erg=heuristic_Erg;
load('Optimist_no_rnd_Erg.mat')
Optimist_Erg=heuristic_Erg;
load('Pessimist_no_rnd_Erg.mat')
Pessimist_Erg=heuristic_Erg;
load('Random_no_rnd_Erg.mat')
...
for i=2:2 %goal
    for j=1:4 %complexity
        ...
        plot_goal_results_no_rnd(Time_Limit,heuristics_result_matrix_s,matr_size, x_upper_limit(1,j),y_upper_limit(i,j),y_lower_limit(i,j), i, j);
    end
end
